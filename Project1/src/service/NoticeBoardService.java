...
public class NoticeBoardService {
	...
	public int NoticeList(){
		...
		while(true){
		// 비회원
		if ((Controller.loginUser == null ||Controller.loginUser.size() == 0)	//LoginUser 가 null이고 
...
//						return View.HOME;			관리자
	...
	private void noticeinsert001() {
		...
		String id = Controller.loginManager.get("MANAGER_ID").toString();
		...
		switch (insert) {
		case 1:
			int result = noticeDao.insertNotice(write01,write02,id);
				if (result == 1) {
